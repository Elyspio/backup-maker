...
import { ExtraArgument, RealStoreState } from "@store";

type Constructor<T> = new (...args: any[]) => T;

export function getService<T>(service: Constructor<T> | symbol, extra: ExtraArgument): T {
...
type ThunkParam = { extra: ExtraArgument; state: RealStoreState };
