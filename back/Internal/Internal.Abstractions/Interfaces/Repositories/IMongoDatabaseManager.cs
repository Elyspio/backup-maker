...
public interface IMongoDatabaseManager
{
	...
	/// </summary>
	/// <param name="connectionString">The connection string to the MongoDB server.</param>
	/// <param name="elements">A dictionary of elements to be included in the backup. The key is the database name, and the value is a list of collection names within that database.</param>
